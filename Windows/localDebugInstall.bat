...
IF NOT EXIST "%TARGET_APP_SCRIPT_DIR%" (
    ...
    IF EXIST "%PROJECT_ROOT_DIR%run_as_UXPScript.%TARGET_FILENAME_EXTENSION%" (
    ...
    IF EXIST "%PROJECT_ROOT_DIR%run.%TARGET_FILENAME_EXTENSION%" (
        MKLINK /H "%TARGET_SCRIPT_ROOT_DIR%run.%TARGET_FILENAME_EXTENSION%" "%PROJECT_ROOT_DIR%run.%TARGET_FILENAME_EXTENSION%"
    )

    IF EXIST "%PROJECT_ROOT_DIR%run_as_ExtendScript.jsx" (
        MKLINK /H "%TARGET_SCRIPT_ROOT_DIR%run_as_ExtendScript.jsx" "%PROJECT_ROOT_DIR%run_as_ExtendScript.jsx"
    )

    IF EXIST "%PROJECT_ROOT_DIR%run.jsx" (
